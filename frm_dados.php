...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cabeçalho dos Relatórios</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                        ...
                        <form action="gv_dados.php" method="post" id="formdd" name="formdd">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cbnome" class="form-control" id="cbnome"
                                           value="<?php echo $cbnome; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cbend1">Endereço linha 1</label>
                                    <input type="text" name="cbend1" class="form-control" id="cbend1"
                                           value="<?php echo $cbend1; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cbend2">Endereço linha 2</label>
                                    <input type="text" name="cbend2" class="form-control" id="cbend2"
                                           value="<?php echo $cbend2; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cbend3">Endereço linha 3</label>
                                    <input type="text" name="cbend3" class="form-control" id="cbend3"
                                           value="<?php echo $cbend3; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cbend4">Município</label>
                                    <input type="text" name="cbend4" class="form-control" id="cbend4"
                                           value="<?php echo $cbend4; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cbcont1">Contato linha 1</label>
                                    <input type="text" name="cbcont1" class="form-control" id="cbcont1"
                                           value="<?php echo $cbcont1; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cbcont2">Contato linha 2</label>
                                    <input type="text" name="cbcont2" class="form-control" id="cbcont2"
                                           value="<?php echo $cbcont2; ?>">
                                </div>
                            </div>
                            <!-- /.card-body -->
                    ...
                    <!-- /.card -->
                    <button type="button" class="btn btn-block btn-primary bg-gradient-primary btn-sm"
                            onClick="$('#main-body').load('frm_logo.php');return false;">Carregar logotipo do município
                    </button>
                    <br>
                </div>
            </div>
