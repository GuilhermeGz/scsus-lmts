...
$lridade = array();
$lridade[0][0] = 0;
$lridade[0][1] = "de 25 até 64";
$lridade[1][0] = 1;
$lridade[1][1] = "de 25 até 30";
$lridade[2][0] = 2;
$lridade[2][1] = "de 31 até 40";
$lridade[3][0] = 3;
$lridade[3][1] = "de 41 até 50";
$lridade[4][0] = 4;
$lridade[4][1] = "de 51 até 60";
$lridade[5][0] = 5;
$lridade[5][1] = "de 61 até 64";
$lridade[6][0] = 6;
$lridade[6][1] = "de 25 até 40";
$lridade[7][0] = 7;
$lridade[7][1] = "de 40 até 60";
$lridade[8][0] = 8;
$lridade[8][1] = "de 50 até 64";
$lridade[9][0] = 9;
$lridade[9][1] = "de 25 até 35";
$lridade[10][0] = 25;
$lridade[10][1] = "25";
$lridade[11][0] = 26;
$lridade[11][1] = "26";
                        ...
                        <div class="card card-warning mt-2">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tbusca" class="form-control" id="tbusca"
                                           value="<?php echo $tbusca; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="idin">Idade inicial</label>
                                    <input type="text" name="idin" class="form-control" id="idin"
                                           value="<?php echo $idin; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="idfi">Idade final</label>
                                    <input type="text" name="idfi" class="form-control" id="idfi"
                                           value="<?php echo $idfi; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="proceds">Procedimentos</label>
                                    <input type="text" name="proceds" class="form-control" id="proceds"
                                           value="<?php echo $proceds; ?>">
                                </div>
                                <div class="form-group">
