    ...
    $dash_ind1 = "	
          <div class=\"col-md-3\" style='margin-bottom: 10px'>
            ...
            <center>
              ...
              <center>
                <span class=\"info-box-text\" style='font-weight: bold'>Indicador 1</span>
                </center>
                <hr style='width: 95%; height:2px; border:none; color:#333; background-color:#333; margin-top: 0px'>           
                <p style='text-align: center'>Proporção de gestantes com pelo menos 6 (seis) consultas pré-natal realizadas, sendo a primeira até a 20ª semana de gestação</p>
                <span class=\"info-box-number\" ><center>" . $num_1 . " [" . ceil($num_prc_1) . "%]</center></span>
                <div class=\"progress\">
                  <div class=\"progress-bar\" style=\"width: " . ceil($num_prc_1) . "%\"></div>
                </div>
                <span class=\"progress-description\"><center>
                  " . $den_ind_1 . "
                  </center>
                </span>
              </div>
    ...
    $dash_ind2 = "	
          <div class=\"col-md-3\" style='margin-bottom: 10px'>
            ...
            <center>
              ...
              <div class=\"info-box-content\">
              <center>
                <span class=\"info-box-text\" style='font-weight: bold'>Indicador 2</span>
                </center>
                <hr style='width: 95%; height:2px; border:none; color:#333; background-color:#333; margin-top: 0px'>
                <p style='text-align: center;'>Proporção de gestantes com realização de exames para sífilis e HIV</p>
                <span class=\"info-box-number\">
                <center>" . $num_2 . " [" . ceil($num_prc_2) . "%]</center>
                </span>
                <div class=\"progress\">
    ...
    $dash_ind3 = "	
          <div class=\"col-md-3\" style='margin-bottom: 10px'>
            ...
            <center>
              ...
              <div class=\"info-box-content\">
              <center>
                <span class=\"info-box-text\" style='font-weight: bold'>Indicador 3</span>
                </center>
                <hr style='width: 95%; height:2px; border:none; color:#333; background-color:#333; margin-top: 0px'>            
                <p style='text-align: center'>Proporção de gestantes com atendimento odontológico realizado</p>
                <span class=\"info-box-number\">
                <center>
                " . $num_3 . " [" . ceil($num_prc_3) . "%]
                </center>
                </span>
                <div class=\"progress\">
    ...
    $dash_ind4 = "	
          <div class=\"col-md-3\" style='margin-bottom: 10px'>
            ...
            <center>
              ...
              <div class=\"info-box-content\">
              <center>
                <span class=\"info-box-text\" style='font-weight: bold'>Indicador 4</span>
                </center>
                <hr style='width: 95%; height:2px; border:none; color:#333; background-color:#333; margin-top: 0px'>
    ...
    $dash_ind5 = "	
          <div class=\"col-md-3\" style='margin-bottom: 10px'>
            ...
            <center>
              ...
              <div class=\"info-box-content\">
              <center>
                <span class=\"info-box-text\" style='font-weight: bold'>Indicador 5</span>
                </center>
                <hr style='width: 95%; height:2px; border:none; color:#333; background-color:#333; margin-top: 0px'>
                <p style='text-align: center'>
    ...
    $dash_ind6 = "	
          <div class=\"col-md-3\">
            ...
            <center>
              ...
              <div class=\"info-box-content\">
              <center>
                <span class=\"info-box-text\" style='font-weight: bold'>Indicador 6</span>
                </center>
                <hr style='width: 95%; height:2px; border:none; color:#333; background-color:#333; margin-top: 0px'>
                <p style='text-align: center'>
                Percentual de pessoas hipertensas com Pressão Arterial aferida em cada semestre
                </p>
                <span class=\"info-box-number\"><center>" . $num_6 . " [" . ceil($num_prc_6) . "%]</center></span>
                <div class=\"progress\">
    ...
    $dash_ind7 = "	
          <div class=\"col-md-3\" style='margin-bottom: 10px;'>
            ...
            <center>
              ...
              <div class=\"info-box-content\">
              <center>
                <span class=\"info-box-text\" style='font-weight: bold'>Indicador 7</span>
                </center>
                <hr style='width: 95%; height:2px; border:none; color:#333; background-color:#333; margin-top: 0px'>
                <p style='text-align: center'>
