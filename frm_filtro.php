            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        ...
                        if ($ap == 'rel_gestantes') {
                            echo('Gestantes');
                        } elseif ($ap == 'rel_mulheres') {
                            echo('Mulheres');
                        } elseif ($ap == 'rel_mexames') {
                            echo('Exames');
                        } elseif ($ap == 'rel_vacinas') {
                            echo('Vacinas');
                        } elseif ($ap == 'rel_hipertensos') {
                            echo('Hipertensos');
                        } elseif ($ap == 'rel_diabeticos') {
                            echo('Diabéticos');
                        }
                        ?>
                    </h1>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">Filtro de busca <small>- informe os dados que necessitam
                                        procurar</small></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
