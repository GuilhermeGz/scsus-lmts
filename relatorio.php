...
<div class="shadow p-3 mb-2 bg-white rounded">
    <div class="row">
        ...
        <div class="col-sm-6">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalGerarRelatorio"
...
<!-- Modal -->
<div class="modal fade" id="modalGerarRelatorio" tabindex="-1" role="dialog" aria-labelledby="modalGerarRelatorioLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document" style="width: 80%">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalGerarRelatorioLabel" style="color: #04467c; font-weight: bold">GERAR RELATÓRIO</h5>
...
-->
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="#" onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_mulheres');return false;"
                           class="nav-link">
                            <i class="fas fa-chart-line nav-icon text-warning"></i>
                            Indicador 4 <small>[gerar]</small>
                        </a>

                        <a href="#" onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_criancas');return false;"
                           class="nav-link">
                            <i class="fas fa-chart-line nav-icon text-warning"></i>
                            Indicador 5 <small>[gerar]</small>
                        </a>

                        <a href="#" onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_hipertensos');return false;"
                           class="nav-link">
                            <i class="fas fa-chart-line nav-icon text-warning"></i>
                            Indicador 6 <small>[gerar]</small>
                        </a>

                        <a href="#" onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_diabeticos');return false;"
                           class="nav-link">
                            <i class="fas fa-chart-line nav-icon text-warning"></i>
                            Indicador 7 <small>[gerar]</small>
                        </a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="#"
                           onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_mexames');return false;"
                           class="nav-link">
                            <i class="fas fa-stethoscope nav-icon text-warning"></i>
                            Exames <small>[gerar]</small>
                        </a>

                        <a href="#"
                           onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_vacinas');return false;"
                           class="nav-link">
                            <i class="fas fa-syringe nav-icon text-warning"></i>
                            Vacinas <small>[gerar]</small>
                        </a>

                        <a href="#"
                           onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_covid1');return false;"
                           class="nav-link">
                            <i class="fas fa-bacterium nav-icon text-warning"></i>
                            COVID-19 Transparência <small>[gerar]</small>
                        </a>

                        <a href="#" onclick="$('#modalGerarRelatorio').modal('hide');$('#main-body').load('prep.php?ap=rel_duplicados');return false;"
                           class="nav-link">
                            <i class="fas fa-chart-line nav-icon text-warning"></i>
                            Duplicados <small>[gerar]</small>
                        </a>
                    </div>
